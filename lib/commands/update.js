...
module.exports = {
  name: 'i18n:update',
  description: 'split bundled i18n-pod locale into pod translations. \nUsage:\n ember i18n:update <locale>',
  works: 'insideProject',
  ...
  run(commandOptions, args) {
    ...
    _.each(
      x => this.updatePodTranslation(x, translations),
      glob.sync(`app/pods/**/translations.${locale}.y*ml`, {})
    )
  },

  updatePodTranslation(filePath, translations) {
    _.flow(
      _.split('/'),
      _.slice(2, -1),
      _.join('/'),
